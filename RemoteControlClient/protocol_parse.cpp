...
char* PROTOCOL_PARSE_HE_TO = 0;
char* PROTOCOL_PARSE_HE_TO_BUFF = 0;

char* PROTOCOL_PARSE_HE = 0;
char* PROTOCOL_PARSE_HE_BUFF = 0;

char PROTOCOL_PARSE_BUFF[MAX_MESSAGE_BUFF_SIZE + 1] = {0};
char PROTOCOL_PARSE_RESULT[MAX_MESSAGE_BUFF_SIZE + 1] = {0};

char PROTOCOL_TO_MESSAGE_BUFF[MAX_TO_MESSAGE_BUFF_SIZE + 1] = {0};
char PROTOCOL_TO_CONETENT_BUFF[MAX_TO_MESSAGE_BUFF_SIZE + 1] = {0};
char PROTOCOL_PARSE_ERROR[64] = {0};



protocol_parse_callback this_callback = 0;
...
int protocol_parse_flag = -1;
char protocol_parse_out_char = 0;
int protocol_parse_short_offset = 0;
int protocol_parse_length = 0;
int protocol_parse_start_index = 0;
protocol_parse_state protocol_parse_state_value = p_uninitz;
